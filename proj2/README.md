...
| Is the name of your project/software unique? | 3 | No other project with the same name |
...
| Is your contributions' policy publicly available? | 3 | contributing.md in an open source project |
